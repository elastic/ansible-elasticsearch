...
```sh
ansible-galaxy install elastic.elasticsearch,v7.16.2
```
...
The above installs Elasticsearch 7.16.2 in a single node 'node1' on the hosts 'localhost'.
